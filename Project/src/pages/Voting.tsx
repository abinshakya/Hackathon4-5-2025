...
const pollsData = [
  {
    id: 1,
    title: 'Choose the Homecoming Concert Artist',
    description: 'Vote for which artist you want to perform at this year\'s homecoming concert.',
    deadline: '2023-09-30',
    status: 'active',
    options: [
      { id: 101, name: 'Taylor Swift', votes: 245 },
      { id: 102, name: 'Drake', votes: 198 },
      { id: 103, name: 'Billie Eilish', votes: 210 },
      { id: 104, name: 'The Weeknd', votes: 187 },
    ],
    userVoted: null,
  },
  {
    ...
    description: 'Vote for your preferred candidate for Student Council President.',
    deadline: '2023-09-25',
    status: 'active',
    options: [
      { id: 201, name: 'Alex Johnson', votes: 156 },
      { id: 202, name: 'Maria Garcia', votes: 143 },
      { id: 203, name: 'David Kim', votes: 125 },
    ],
    userVoted: null,
  },
  {
    id: 3,
    title: 'Fall Festival Theme Selection',
    description: 'Help us choose the theme for this year\'s Fall Festival.',
    deadline: '2023-09-20',
    status: 'active',
    options: [
